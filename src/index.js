...
const questions = [
  ...
  },
  {
    number: 3,
    question:
      "What was the policy taken by Great Britain and France in response to Hitler's advances the 1930's known as?",
  ...
  },
  {
    number: 5,
    question:
      "What demilitarized zone did Hitler fortify in the months leading up the war?",
  ...
  },
  {
    number: 6,
    question:
      "What unfair treaty paved the way for Hitler's rise to power and the Nazi popularity?",
  ...
  document.addEventListener("click", function (e) {
    if (e.target.className == "submit-btn btn") {
      if (answer == questions[questionNumber].correctAnswer) {
        if (answer == 0) {
          var correcti = document.getElementById("choice-0");
          correcti.style.backgroundColor = "#20df3b";
        } else if (answer == 1) {
          var correcti = document.getElementById("choice-1");
          correcti.style.backgroundColor = "#20df3b";
        } else if (answer == 2) {
          var correcti = document.getElementById("choice-2");
          correcti.style.backgroundColor = "#20df3b";
        } else if (answer == 3) {
          var correcti = document.getElementById("choice-3");
          correcti.style.backgroundColor = "#20df3b";
        }
      } else {
        if (answer == 0) {
          var correcti = document.getElementById("choice-0");
          correcti.style.backgroundColor = "#f70f08";
        } else if (answer == 1) {
          var correcti = document.getElementById("choice-1");
          correcti.style.backgroundColor = "#f70f08";
        } else if (answer == 2) {
